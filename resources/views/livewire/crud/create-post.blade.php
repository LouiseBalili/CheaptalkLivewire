<div>
    <div class="container col-6 col-md-6 mt-5">
        <div class="card shadow-sm p-3" style="background-color: #e0f0fc;">
            <h1>Create Post</h1>
            <div class="d-flex">
            ...
            <div class="container mt-3">
                ...
                <button wire:click="cancel" class="btn btn-secondary float-end" style="margin-right: 5px;">Cancel</button>
            </div>
        </div>
    </div>
</div>
